...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <a href="{{ route('admin.cl.lesson.create') }}" class="btn btn-success btn-sm" title="Add New Course">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($lessons as $key => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.cl.lesson.edit', ['lesson' => $item]) }}" title="Edit Course">
                                    <button class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    </button>
                                </a>
                                <form action="{{ route('admin.cl.lesson.destroy', ['lesson' => $item]) }}"
