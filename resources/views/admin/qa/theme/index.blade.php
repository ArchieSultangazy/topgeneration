...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <a href="{{ route('admin.qa.theme.create') }}" class="btn btn-success btn-sm" title="Add New Book">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($themes as $key => $item)
                        <tr>
                            ...
                            <td>{{ $item->name }}</td>
                            <td>
                                <a href="{{ route('admin.qa.theme.edit', ['theme' => $item]) }}" title="Edit Theme">
                                    <button class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    </button>
                                </a>
                                <form action="{{ route('admin.qa.theme.destroy', ['theme' => $item]) }}"
